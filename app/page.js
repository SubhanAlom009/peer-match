          ...
          {!session && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="bg-gray-900 border-2 border-gray-900 text-white hover:bg-transparent hover:text-gray-900 px-8 py-4 text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300 font-semibold"
              >
                <Link href="/auth/signin">Sign In</Link>
              </Button>
            </div>
